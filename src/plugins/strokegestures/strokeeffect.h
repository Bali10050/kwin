...
public:
    ...
    void strokeGestureBegin(const QList<QPointF> &points, std::chrono::microseconds time) override;
    void strokeGestureUpdate(const QList<QPointF> &points, std::chrono::microseconds time) override;
...
Q_SIGNALS:
    ...
    void strokePointAdded(const QPointF &p);
    void strokeEnded();
